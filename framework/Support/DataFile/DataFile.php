...
abstract class DataFile
{
    ...
    protected static function parseKey($params): array
    {
    ...
    protected static function getFileName($baseName): string
    {
        $scope = '';
    ...
    protected static function getDir($scope): string
    {
    ...
    private static function getValue(array $items, $index = null, $default = null)
    {
        if (!$index) {
    ...
    public function load(string $baseName): static
    {
        $fileName = static::getFileName($baseName);

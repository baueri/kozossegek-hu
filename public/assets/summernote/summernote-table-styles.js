...
(function (factory) {
  ...
  $.extend(true, $.summernote.lang, {
    "en-US": {
      tableStyles: {
        tooltip: "Tábla Stílusa",
        stylesExclusive: ["Alapértelmezett", "Keretezett", "Keret nélkül"],
        stylesInclusive: ["Csíkozott", "Sűrített", "Hovered"]
      }
    }
  });
  $.extend($.summernote.options, {
    tableStyles: {
      ...
      stylesExclusive: ["", "table-bordered", "table-borderless"],

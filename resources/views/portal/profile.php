        ...
        <div class="col-md-9">
            ...
            <form method="post" action="@route('portal.profile.update')" class="mb-4">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-12">
                        <h6><b>Közösségi fiókok</b></h6>
                        @foreach($socialProfiles as $profile)
                        <p>
                            <i class="{{ $profile->icon() }}"></i> - {{ $profile->text() }}<br/>
                            <a href="@route('portal.detach_social_profile', ['provider' => $profile->social_provider])" class="small" style="color: darkorange; font-size: 12px; font-weight: bold;">
                                @icon('trash-alt')
                                szétkapcsolás
                            </a>
                        </p>

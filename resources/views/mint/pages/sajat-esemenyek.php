<mint-extend path="layout/inner.php" :subtitle="Eseményeim | " :page-title="Eseményeim" :inner-container="container-fluid" :inner-class="inner--account">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center">
                                    @if($event->isApproved())
                                        <a href="{{ $event->getUrl() }}" class="text-muted" title="Megtekintés" target="_blank" rel="noopener"><mod-icon :name="{'eye'}" /></a>
                                    @else
                                        <span class="text-muted" title="Csak jóváhagyás után érhető el nyilvánosan"><mod-icon :name="{'eye-slash'}" /></span>
                                    @endif
                                </td>
                                <td>
                                    <a href="@route('portal.my_event.edit', ['id' => $event->id])" title="Szerkesztés"><mod-icon :name="{'edit'}" /> {{ $event->name }}</a>
                                </td>

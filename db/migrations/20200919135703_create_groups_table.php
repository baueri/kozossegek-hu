...
final class CreateGroupsTable extends \App\Migration\AppMigration
{
    ...
    public function up(): void
    {
         $this->table('groups')
                 ...
                 ->addColumn('denomination', MysqlAdapter::PHINX_TYPE_ENUM, ['values' => DenominationEnum::all(), 'default' => DenominationEnum::KATOLIKUS, 'comment' => 'felekezet'])
                 ...
                 ->addColumn('age_group', MysqlAdapter::PHINX_TYPE_ENUM, ['values' => App\Enums\AgeGroupEnum::all(), 'comment' => 'korosztály'])
                 ->addColumn('occasion_frequency', MysqlAdapter::PHINX_TYPE_ENUM, ['values' => App\Enums\OccasionFrequencyEnum::all(), 'comment' => 'milyen gyakran találkoznak a közösségek'])
                 ->addColumn('status', MysqlAdapter::PHINX_TYPE_ENUM, ['values' => App\Enums\GroupStatusEnum::all()])
                 ->timestamps()
                 ->addIndex('name')
                 ->addIndex('city')

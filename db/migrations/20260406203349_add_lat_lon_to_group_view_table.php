...
final class AddLatLonToGroupViewTable extends AbstractMigration
{
    public function up(): void
    {
        $this->execute(<<<SQL
            ...
            SELECT
                ...
                COALESCE(users.email, church_groups.group_leader_email) as group_leader_email,
                ...
                church_groups.notified_at,
                church_groups.confirmed_at,

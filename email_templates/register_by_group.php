...
<div style="text-align: justify;">
    ...
    <p style="text-align: center;">
        <a href="{{ $token_url }}" style="padding: .4em .8em; border-radius: 4px; display: inline-block; background: #dc3545; color: #fff; text-decoration: none; font-family: sans-serif">regisztráció megerősítése</a>
    </p>
</div>
